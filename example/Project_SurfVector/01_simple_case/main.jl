...
+------------------------------------------------------------------------------------------+
|  File Name  : main.jl                                                                    |
|  Description: To get the velocity vector on the slide surface                            |
...
init_mp_in_space  = 2
init_project_name = "3d_slumping_vector"
...
# MPM solver
materialpointsolver!(args, grid, mp, bc)
...
let
    ...
    scatter!(axis, mp.pos, color=log10.(mp.epII.+1))
    display(fig)
